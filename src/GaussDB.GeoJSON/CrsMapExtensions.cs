...
public static class CrsMapExtensions
{
    ...
    public static async Task<CrsMap> GetCrsMapAsync(this GaussDBDataSource dataSource)
    {
    ...
    /// </summary>
    /// <param name="dataSource"></param>
    public static CrsMap GetCrsMap(this GaussDBDataSource dataSource)
    {
        var builder = new CrsMapBuilder();
        using var cmd = GetCsrCommand(dataSource);
    ...
    static GaussDBCommand GetCsrCommand(GaussDBDataSource dataSource)
