...
/// </remarks>
public class GaussDBDbColumn : DbColumn
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GaussDBDbColumn" /> class.
    /// </summary>
    public GaussDBDbColumn()
    {
    ...
    internal GaussDBDbColumn Clone() =>
        (GaussDBDbColumn)MemberwiseClone();
    ...
    #region GaussDB-specific fields
    ...
    /// <summary>
    /// The <see cref="GaussDBDbType" /> value for this column's type.
    /// </summary>
    public GaussDBDbType? GaussDBDbType { get; internal set; }
    ...
    public override object? this[string propertyName]
        => propertyName switch
        {
            ...
            nameof(GaussDBDbType)          => GaussDBDbType,
            _                             => base[propertyName]
        };

    #endregion GaussDB-specific fields
}
