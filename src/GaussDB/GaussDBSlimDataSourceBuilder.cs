...
/// NativeAOT), use <see cref="GaussDBDataSourceBuilder" /> instead.
/// </remarks>
public sealed class GaussDBSlimDataSourceBuilder : IGaussDBTypeMapper
{
    static UnsupportedTypeInfoResolver<GaussDBSlimDataSourceBuilder> UnsupportedTypeInfoResolver { get; } = new();

    ILoggerFactory? _loggerFactory;
    bool _sensitiveDataLoggingEnabled;
    List<Action<GaussDBTracingOptionsBuilder>>? _tracingOptionsBuilderCallbacks;
    List<Action<GaussDBTypeLoadingOptionsBuilder>>? _typeLoadingOptionsBuilderCallbacks;
    ...
    Func<GaussDBConnectionStringBuilder, string>? _passwordProvider;
    Func<GaussDBConnectionStringBuilder, CancellationToken, ValueTask<string>>? _passwordProviderAsync;

    Func<GaussDBConnectionStringBuilder, CancellationToken, ValueTask<string>>? _periodicPasswordProvider;
    ...
    Action<GaussDBConnection>? _connectionInitializer;
    Func<GaussDBConnection, Task>? _connectionInitializerAsync;

    internal JsonSerializerOptions? JsonSerializerOptions { get; private set; }

    internal Action<GaussDBSlimDataSourceBuilder> ConfigureDefaultFactories { get; set; }

    /// <summary>
    /// A connection string builder that can be used to configured the connection string on the builder.
    /// </summary>
    public GaussDBConnectionStringBuilder ConnectionStringBuilder { get; }
    ...
    static GaussDBSlimDataSourceBuilder()
        => GlobalTypeMapper.Instance.AddGlobalTypeMappingResolvers([new AdoTypeInfoResolverFactory()]);

    /// <summary>
    /// A diagnostics name used by GaussDB when generating tracing, logging and metrics.
    /// </summary>
    public string? Name { get; set; }

    /// <summary>
    /// Constructs a new <see cref="GaussDBSlimDataSourceBuilder" />, optionally starting out from the given
    /// <paramref name="connectionString"/>.
    /// </summary>
    public GaussDBSlimDataSourceBuilder(string? connectionString = null)
        : this(new GaussDBConnectionStringBuilder(connectionString))
    {}

    internal GaussDBSlimDataSourceBuilder(GaussDBConnectionStringBuilder connectionStringBuilder)
    {
    ...
    public GaussDBSlimDataSourceBuilder UseLoggerFactory(ILoggerFactory? loggerFactory)
    {
    ...
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableParameterLogging(bool parameterLoggingEnabled = true)
    {
    ...
    /// the prior action.
    /// </summary>
    public GaussDBSlimDataSourceBuilder ConfigureTypeLoading(Action<GaussDBTypeLoadingOptionsBuilder> configureAction)
    {
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder ConfigureTracing(Action<GaussDBTracingOptionsBuilder> configureAction)
    {
        ArgumentNullException.ThrowIfNull(configureAction);
    ...
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder ConfigureJsonOptions(JsonSerializerOptions serializerOptions)
    {
    ...
    public GaussDBSlimDataSourceBuilder UseUserCertificateValidationCallback(
    ...
    /// <summary>
    /// Specifies an SSL/TLS certificate which GaussDB will send to PostgreSQL for certificate-based authentication.
    /// </summary>
    /// <param name="clientCertificate">The client certificate to be sent to PostgreSQL when opening a connection.</param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    [Obsolete("Use UseSslClientAuthenticationOptionsCallback")]
    public GaussDBSlimDataSourceBuilder UseClientCertificate(X509Certificate? clientCertificate)
    {
    ...
    /// <summary>
    /// Specifies a collection of SSL/TLS certificates which GaussDB will send to PostgreSQL for certificate-based authentication.
    /// </summary>
    /// <param name="clientCertificates">The client certificate collection to be sent to PostgreSQL when opening a connection.</param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    [Obsolete("Use UseSslClientAuthenticationOptionsCallback")]
    public GaussDBSlimDataSourceBuilder UseClientCertificates(X509CertificateCollection? clientCertificates)
    ...
    /// </remarks>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder UseSslClientAuthenticationOptionsCallback(Action<SslClientAuthenticationOptions>? sslClientAuthenticationOptionsCallback)
    {
    ...
    /// <summary>
    /// Specifies a callback to modify the collection of SSL/TLS client certificates which GaussDB will send to PostgreSQL for
    ...
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    [Obsolete("Use UseSslClientAuthenticationOptionsCallback")]
    public GaussDBSlimDataSourceBuilder UseClientCertificatesCallback(Action<X509CertificateCollection>? clientCertificatesCallback)
    {
    ...
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder UseRootCertificate(X509Certificate2? rootCertificate)
    ...
    /// </remarks>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder UseRootCertificateCallback(Func<X509Certificate2>? rootCertificateCallback)
    {
    ...
    /// </remarks>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder UsePeriodicPasswordProvider(
        Func<GaussDBConnectionStringBuilder, CancellationToken, ValueTask<string>>? passwordProvider,
        TimeSpan successRefreshInterval,
        TimeSpan failureRefreshInterval)
    {
        if (successRefreshInterval < TimeSpan.Zero)
            throw new ArgumentException(
                string.Format(GaussDBStrings.ArgumentMustBePositive, nameof(successRefreshInterval)), nameof(successRefreshInterval));
        if (failureRefreshInterval < TimeSpan.Zero)
            throw new ArgumentException(
                string.Format(GaussDBStrings.ArgumentMustBePositive, nameof(failureRefreshInterval)), nameof(failureRefreshInterval));
    ...
    /// A callback that may be invoked during <see cref="GaussDBConnection.Open()" /> which returns the password to be sent to PostgreSQL.
    /// </param>
    /// <param name="passwordProviderAsync">
    /// A callback that may be invoked during <see cref="GaussDBConnection.OpenAsync(CancellationToken)" /> which returns the password to be sent to PostgreSQL.
    /// </param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public GaussDBSlimDataSourceBuilder UsePasswordProvider(
        ...
        Func<GaussDBConnectionStringBuilder, CancellationToken, ValueTask<string>>? passwordProviderAsync)
    {
        if (passwordProvider is null != passwordProviderAsync is null)
            throw new ArgumentException(GaussDBStrings.SyncAndAsyncPasswordProvidersRequired);
    ...
    /// </remarks>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder UseNegotiateOptionsCallback(Action<NegotiateAuthenticationClientOptions>? negotiateOptionsCallback)
    {
    ...
    /// <inheritdoc />
    public IGaussDBNameTranslator DefaultNameTranslator
    {
    ...
    /// which defaults to <see cref="GaussDBSnakeCaseNameTranslator"/>.
    ...
    public GaussDBSlimDataSourceBuilder MapEnum<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TEnum>(string? pgName = null, IGaussDBNameTranslator? nameTranslator = null)
    ...
    /// <inheritdoc />
    public bool UnmapEnum<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TEnum>(string? pgName = null, IGaussDBNameTranslator? nameTranslator = null)
        where TEnum : struct, Enum
    ...
    public GaussDBSlimDataSourceBuilder MapEnum([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)]
    ...
    public GaussDBSlimDataSourceBuilder MapComposite<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicFields)] T>(
    ...
    /// </param>
    [RequiresDynamicCode("Mapping composite types involves serializing arbitrary types which can require creating new generic types or methods. This is currently unsupported with NativeAOT, vote on issue #5303 if this is important to you.")]
    public GaussDBSlimDataSourceBuilder MapComposite([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicFields)]
        Type clrType, string? pgName = null, IGaussDBNameTranslator? nameTranslator = null)
    {
    ...
    /// <inheritdoc />
    void IGaussDBTypeMapper.Reset() => _resolverChainBuilder.Clear();
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableArrays()
    {
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableRanges()
    {
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableMultiranges()
    {
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableRecords()
    {
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableFullTextSearch()
    {
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableLTree()
    {
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableExtraConversions()
    {
    ...
    /// actually be used; see <see href="https://www.gaussdb.org/doc/security.html"/> for more details.
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableTransportSecurity()
    {
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableIntegratedSecurity()
    {
    ...
    /// <summary>
    /// Sets up network mappings. This allows mapping PhysicalAddress, IPAddress, GaussDBInet and GaussDBCidr types
    /// to PostgreSQL <c>macaddr</c>, <c>macaddr8</c>, <c>inet</c> and <c>cidr</c> types.
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableNetworkTypes()
    {
    ...
    /// <summary>
    /// Sets up network mappings. This allows mapping types like GaussDBPoint and GaussDBPath
    /// to PostgreSQL <c>point</c>, <c>path</c> and so on types.
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableGeometricTypes()
    {
    ...
    /// </summary>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder EnableJsonTypes()
    {
    ...
    public GaussDBSlimDataSourceBuilder EnableDynamicJson(
    ...
    public GaussDBSlimDataSourceBuilder EnableRecordsAsTuples()
    {
    ...
    public GaussDBSlimDataSourceBuilder EnableUnmappedTypes()
    {
    ...
    /// A synchronous connection initialization lambda, which will be called from <see cref="GaussDBConnection.Open()" /> when a new physical
    /// connection is opened.
    /// </param>
    /// <param name="connectionInitializerAsync">
    /// An asynchronous connection initialization lambda, which will be called from
    /// <see cref="GaussDBConnection.OpenAsync(CancellationToken)" /> when a new physical connection is opened.
    /// </param>
    /// <remarks>
    ...
    /// GaussDB sends <c>DISCARD ALL</c> by default. The <see cref="GaussDBConnectionStringBuilder.NoResetOnClose" /> option can be used to
    /// turn this off.
    /// </remarks>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    public GaussDBSlimDataSourceBuilder UsePhysicalConnectionInitializer(
        ...
        Func<GaussDBConnection, Task>? connectionInitializerAsync)
    {
        if (connectionInitializer is null != connectionInitializerAsync is null)
            throw new ArgumentException(GaussDBStrings.SyncAndAsyncConnectionInitializersRequired);
    ...
    /// <summary>
    /// Builds and returns an <see cref="GaussDBDataSource" /> which is ready for use.
    /// </summary>
    public GaussDBDataSource Build()
    {
        ...
        if (ConnectionStringBuilder.Host!.Contains(','))
        {
            ...
            return new GaussDBMultiHostDataSource(connectionStringBuilder, config);
        }
    ...
    /// <summary>
    /// Builds and returns a <see cref="GaussDBMultiHostDataSource" /> which is ready for use for load-balancing and failover scenarios.
    /// </summary>
    public GaussDBMultiHostDataSource BuildMultiHost()
    {
        var (connectionStringBuilder, config) = PrepareConfiguration();
    ...
    (GaussDBConnectionStringBuilder, GaussDBDataSourceConfiguration) PrepareConfiguration()
    {
        ...
        {
            throw new NotSupportedException(GaussDBStrings.SslClientAuthenticationOptionsCallbackWithOtherCallbacksNotSupported);
        }
        ...
        {
            throw new InvalidOperationException(GaussDBStrings.TransportSecurityDisabled);
        }

        if (_passwordProvider is not null && _periodicPasswordProvider is not null)
        {
            throw new NotSupportedException(GaussDBStrings.CannotSetMultiplePasswordProviderKinds);
        }

        if ((_passwordProvider is not null || _periodicPasswordProvider is not null) &&
            (ConnectionStringBuilder.Password is not null || ConnectionStringBuilder.Passfile is not null))
        {
            throw new NotSupportedException(GaussDBStrings.CannotSetBothPasswordProviderAndPassword);
        }

        ConfigureDefaultFactories(this);

        var typeLoadingOptionsBuilder = new GaussDBTypeLoadingOptionsBuilder();
...
#pragma warning restore CS0618 // Type or member is obsolete
        foreach (var callback in _typeLoadingOptionsBuilderCallbacks ?? (IEnumerable<Action<GaussDBTypeLoadingOptionsBuilder>>)[])
            callback.Invoke(typeLoadingOptionsBuilder);
        var typeLoadingOptions = typeLoadingOptionsBuilder.Build();

        var tracingOptionsBuilder = new GaussDBTracingOptionsBuilder();
        foreach (var callback in _tracingOptionsBuilderCallbacks ?? (IEnumerable<Action<GaussDBTracingOptionsBuilder>>)[])
        ...
        return (connectionStringBuilder, new(
            ...
            _loggerFactory is null
                ? GaussDBLoggingConfiguration.NullConfiguration
                : new GaussDBLoggingConfiguration(_loggerFactory, _sensitiveDataLoggingEnabled),
            tracingOptions,
            typeLoadingOptions,
    ...
    void ValidateMultiHost()
    {
        if (ConnectionStringBuilder.TargetSessionAttributes is not null)
            throw new InvalidOperationException(GaussDBStrings.CannotSpecifyTargetSessionAttributes);
    ...
    IGaussDBTypeMapper IGaussDBTypeMapper.ConfigureJsonOptions(JsonSerializerOptions serializerOptions)
    ...
    IGaussDBTypeMapper IGaussDBTypeMapper.EnableDynamicJson(Type[]? jsonbClrTypes, Type[]? jsonClrTypes)
    ...
    IGaussDBTypeMapper IGaussDBTypeMapper.EnableRecordsAsTuples()
    ...
    IGaussDBTypeMapper IGaussDBTypeMapper.EnableUnmappedTypes()
        => EnableUnmappedTypes();

    /// <inheritdoc />
    IGaussDBTypeMapper IGaussDBTypeMapper.MapEnum<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields)] TEnum>(string? pgName, IGaussDBNameTranslator? nameTranslator)
    {
        _userTypeMapper.MapEnum<TEnum>(pgName, nameTranslator);
        return this;
    }
    ...
    /// <inheritdoc />
    [RequiresDynamicCode("Calling MapEnum with a Type can require creating new generic types or methods. This may not work when AOT compiling.")]
    IGaussDBTypeMapper IGaussDBTypeMapper.MapEnum([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)]
        Type clrType, string? pgName, IGaussDBNameTranslator? nameTranslator)
    {
        _userTypeMapper.MapEnum(clrType, pgName, nameTranslator);
        return this;
    }
    ...
    /// <inheritdoc />
    [RequiresDynamicCode("Mapping composite types involves serializing arbitrary types which can require creating new generic types or methods. This is currently unsupported with NativeAOT, vote on issue #5303 if this is important to you.")]
    IGaussDBTypeMapper IGaussDBTypeMapper.MapComposite<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicFields)] T>(
        string? pgName, IGaussDBNameTranslator? nameTranslator)
    {
        _userTypeMapper.MapComposite(typeof(T), pgName, nameTranslator);
        return this;
    }
    ...
    /// <inheritdoc />
    [RequiresDynamicCode("Mapping composite types involves serializing arbitrary types which can require creating new generic types or methods. This is currently unsupported with NativeAOT, vote on issue #5303 if this is important to you.")]
    IGaussDBTypeMapper IGaussDBTypeMapper.MapComposite([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicFields)]
        Type clrType, string? pgName, IGaussDBNameTranslator? nameTranslator)
    {
        _userTypeMapper.MapComposite(clrType, pgName, nameTranslator);
        return this;
