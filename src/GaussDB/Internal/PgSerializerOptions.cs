...
public sealed class PgSerializerOptions
{
    ...
    internal PgSerializerOptions(GaussDBDatabaseInfo databaseInfo, PgTypeInfoResolverChain? resolverChain = null, Func<string>? timeZoneProvider = null)
    {
    ...
    internal GaussDBDatabaseInfo DatabaseInfo { get; }
    ...
    public IGaussDBNameTranslator DefaultNameTranslator { get; init; } = GaussDBSnakeCaseNameTranslator.Instance;
