...
sealed class NetworkTypeInfoResolverFactory : PgTypeInfoResolverFactory
{
    ...
    class Resolver : IPgTypeInfoResolver
    {
        ...
        static TypeInfoMappingCollection AddMappings(TypeInfoMappingCollection mappings)
        {
            ...
            mappings.AddStructType<GaussDBInet>(DataTypeNames.Inet,
                static (options, mapping, _) => mapping.CreateInfo(options, new GaussDBInetConverter()));
...
#pragma warning disable CS0618 // GaussDBCidr is obsolete
            mappings.AddStructType<GaussDBCidr>(DataTypeNames.Cidr,
                static (options, mapping, _) => mapping.CreateInfo(options, new GaussDBCidrConverter()));
#pragma warning restore CS0618
    ...
    sealed class ArrayResolver : Resolver, IPgTypeInfoResolver
    {
        ...
        static TypeInfoMappingCollection AddMappings(TypeInfoMappingCollection mappings)
        {
            ...
            mappings.AddStructArrayType<GaussDBInet>(DataTypeNames.Inet);

            // cidr
            mappings.AddStructArrayType<IPNetwork>(DataTypeNames.Cidr);
#pragma warning disable CS0618 // GaussDBCidr is obsolete
            mappings.AddStructArrayType<GaussDBCidr>(DataTypeNames.Cidr);
#pragma warning restore CS0618
