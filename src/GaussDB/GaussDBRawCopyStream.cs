...
/// a PostgreSQL table. Initiated by <see cref="GaussDBConnection.BeginRawBinaryCopy(string)"/>
/// </summary>
/// <remarks>
/// See https://www.postgresql.org/docs/current/static/sql-copy.html.
/// </remarks>
public sealed class GaussDBRawCopyStream : Stream, ICancelable
{
    #region Fields and Properties

    GaussDBConnector _connector;
    GaussDBReadBuffer _readBuf;
    GaussDBWriteBuffer _writeBuf;
    ...
    internal GaussDBRawCopyStream(GaussDBConnector connector)
    {
...
#pragma warning restore CS8625
    ...
    {
        if (_isDisposed) {
            throw new ObjectDisposedException(nameof(GaussDBRawCopyStream), "The COPY operation has already ended.");
        }
    }
...
/// <summary>
/// Writer for a text import, initiated by <see cref="GaussDBConnection.BeginTextImport(string)"/>.
/// </summary>
/// <remarks>
/// See https://www.postgresql.org/docs/current/static/sql-copy.html.
/// </remarks>
public sealed class GaussDBCopyTextWriter : StreamWriter, ICancelable
{
    internal GaussDBCopyTextWriter(GaussDBConnector connector, GaussDBRawCopyStream underlying) : base(underlying)
    {
    ...
    /// </summary>
    public void Cancel()
        => ((GaussDBRawCopyStream)BaseStream).Cancel();

    /// <summary>
    /// Cancels and terminates an ongoing import. Any data already written will be discarded.
    /// </summary>
    public Task CancelAsync() => ((GaussDBRawCopyStream)BaseStream).CancelAsync();
}

/// <summary>
/// Reader for a text export, initiated by <see cref="GaussDBConnection.BeginTextExport(string)"/>.
/// </summary>
/// <remarks>
/// See https://www.postgresql.org/docs/current/static/sql-copy.html.
/// </remarks>
public sealed class GaussDBCopyTextReader : StreamReader, ICancelable
{
    internal GaussDBCopyTextReader(GaussDBConnector connector, GaussDBRawCopyStream underlying) : base(underlying)
    {
        if (underlying.IsBinary)
