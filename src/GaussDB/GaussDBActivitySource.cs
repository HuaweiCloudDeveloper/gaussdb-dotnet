...
static class GaussDBActivitySource
{
    ...
    internal static Activity? CommandStart(GaussDBConnectionStringBuilder settings, string commandText, CommandType commandType, string? spanName)
    {
        ...
        case CommandType.StoredProcedure:
            dbOperation = GaussDBCommand.EnableStoredProcedureCompatMode ? "SELECT" : "CALL";
    ...
    internal static Activity? ConnectionOpen(GaussDBConnector connector)
    {
    ...
    internal static void Enrich(Activity activity, GaussDBConnector connector)
    {
    ...
    internal static void ReceivedFirstResponse(Activity activity, GaussDBTracingOptions tracingOptions)
    {
