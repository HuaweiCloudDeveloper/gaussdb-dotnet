...
public sealed class PostgresNotice
{
    ...
    internal static PostgresNotice Load(GaussDBReadBuffer buf, bool includeDetail, ILogger exceptionLogger)
...
/// </summary>
public sealed class GaussDBNoticeEventArgs : EventArgs
{
    /// <summary>
    ...
    internal GaussDBNoticeEventArgs(PostgresNotice notice)
        => Notice = notice;
}
