...
/// </summary>
public sealed class GaussDBTsVector : IEnumerable<GaussDBTsVector.Lexeme>, IEquatable<GaussDBTsVector>
{
    readonly List<Lexeme> _lexemes;

    internal GaussDBTsVector(List<Lexeme> lexemes, bool noCheck = false)
    {
        if (noCheck)
        {
            _lexemes = lexemes;
    ...
    /// <returns></returns>
    [Obsolete("Client-side parsing of GaussDBTsVector is unreliable and cannot fully duplicate the PostgreSQL logic. Use PG functions instead (e.g. to_tsvector)")]
    public static GaussDBTsVector Parse(string value)
    {
        ...
        Finish:
        return new GaussDBTsVector(lexemes);
    }
    ...
    /// <inheritdoc />
    public bool Equals(GaussDBTsVector? other)
    {
    ...
    public override bool Equals(object? obj)
        => obj is GaussDBTsVector other && Equals(other);
