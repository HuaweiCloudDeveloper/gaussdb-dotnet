...
public class PhysicalReplicationSlot : ReplicationSlot
{
    ...
    public PhysicalReplicationSlot(string slotName, GaussDBLogSequenceNumber? restartLsn = null, uint? restartTimeline = null)
        : base(slotName)
    {
    ...
    /// </summary>
    public GaussDBLogSequenceNumber? RestartLsn { get; }
