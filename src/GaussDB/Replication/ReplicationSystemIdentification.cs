...
{
    internal ReplicationSystemIdentification(string systemId, uint timeline, GaussDBLogSequenceNumber xLogPos, string dbName)
    {
        SystemId = systemId;
        Timeline = timeline;
        XLogPos = xLogPos;
    ...
    /// </summary>
    public GaussDBLogSequenceNumber XLogPos { get; }
