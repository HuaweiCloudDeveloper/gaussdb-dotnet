...
public sealed class PhysicalReplicationConnection : ReplicationConnection
{
    ...
    /// <returns>A <see cref="Task{T}"/> representing an <see cref="IAsyncEnumerable{GaussDBXLogDataMessage}"/> that
    ...
    public IAsyncEnumerable<XLogDataMessage> StartReplication(
        GaussDBLogSequenceNumber walLocation, CancellationToken cancellationToken, uint timeline = default)
