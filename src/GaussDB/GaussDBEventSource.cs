...
sealed class GaussDBEventSource : EventSource
{
    ...
    readonly Dictionary<GaussDBDataSource, (PollingCounter IdleConnectionsCounter, PollingCounter BusyConnectionsCounter)?> _dataSources = new();
    ...
    internal GaussDBEventSource() : base(EventSourceName) {}
    ...
    public void CommandStart(string sql)
    {
        ...
        GaussDBSqlEventSource.Log.CommandStart(sql);
    }
    ...
    public void CommandStop()
    {
        ...
        GaussDBSqlEventSource.Log.CommandStop();
    }
    ...
    internal void DataSourceCreated(GaussDBDataSource dataSource)
    {
