...
sealed class PreparedStatementManager
{
    ...
    internal PreparedStatementManager(GaussDBConnector connector)
    {
    ...
    internal PreparedStatement? GetOrAddExplicit(GaussDBBatchCommand batchCommand)
    {
    ...
    internal PreparedStatement? TryGetAutoPrepared(GaussDBBatchCommand batchCommand)
    {
        var sql = batchCommand.FinalCommandText!;
        ...
        PreparedStatement? TryGetAutoPreparedSlow(GaussDBBatchCommand batchCommand, PreparedStatement? pStatement)
        {
            var sql = batchCommand.FinalCommandText!;
