...
sealed class UserTypeMapper : PgTypeInfoResolverFactory
{
    ...
    IGaussDBNameTranslator _defaultNameTranslator = GaussDBSnakeCaseNameTranslator.Instance;
    ...
    public UserTypeMapper MapEnum([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicFields | DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)]Type clrType, string? pgName = null, IGaussDBNameTranslator? nameTranslator = null)
    {
        ...
        var openMethod = typeof(UserTypeMapper).GetMethod(nameof(MapEnum), [typeof(string), typeof(IGaussDBNameTranslator)])!;
        ...
        Type clrType, string? pgName = null, IGaussDBNameTranslator? nameTranslator = null)
    {
        ...
        var openMethod = typeof(UserTypeMapper).GetMethod(
            ...
            [typeof(string), typeof(IGaussDBNameTranslator)])!;
    ...
    sealed class CompositeMapping<
        ...
        T>(string pgTypeName, IGaussDBNameTranslator nameTranslator) : UserTypeMapping(pgTypeName, typeof(T))
        where T : class
    {
    ...
    {
        internal IGaussDBNameTranslator NameTranslator { get; } = nameTranslator;
    }
