...
static class TaskTimeoutAndCancellation
{
    ...
    internal static async Task<TResult> ExecuteAsync<TResult>(Func<CancellationToken, Task<TResult>> getTaskFunc, GaussDBTimeout timeout, CancellationToken cancellationToken)
    {
    ...
    internal static async Task ExecuteAsync(Func<CancellationToken, Task> getTaskFunc, GaussDBTimeout timeout, CancellationToken cancellationToken)
    {
