...
/// </summary>
/// <remarks>
/// Note that pools created directly as <see cref="GaussDBDataSource" /> are referenced directly by users, and aren't managed here.
/// </remarks>
static class PoolManager
{
    internal static ConcurrentDictionary<string, GaussDBDataSource> Pools { get; } = new();
