...
/// Other errors (e.g. network issues) will be raised via <see cref="GaussDBException" />,
/// and purely GaussDB-related issues which aren't related to the server will be raised
...
/// </remarks>
[Serializable]
public sealed class PostgresException : GaussDBException
{
    /// <summary>
    ...
    internal static PostgresException Load(GaussDBReadBuffer buf, bool includeDetail, ILogger exceptionLogger)
