...
/// names (some_class)
/// </summary>
public sealed class GaussDBSnakeCaseNameTranslator : IGaussDBNameTranslator
{
    internal static GaussDBSnakeCaseNameTranslator Instance { get; } = new();

    readonly CultureInfo _culture;

    /// <summary>
    /// Creates a new <see cref="GaussDBSnakeCaseNameTranslator"/>.
    /// </summary>
    /// <param name="culture">
    ...
    /// </param>
    public GaussDBSnakeCaseNameTranslator(CultureInfo? culture = null)
        : this(false, culture) { }
    ...
    /// If <see langword="null"/> then <see cref="CultureInfo.InvariantCulture"/> will be used.
    /// </param>
    public GaussDBSnakeCaseNameTranslator(bool legacyMode, CultureInfo? culture = null)
    {
