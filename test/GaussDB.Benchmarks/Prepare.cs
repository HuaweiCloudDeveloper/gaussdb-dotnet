...
{
    GaussDBConnection _conn = default!, _autoPreparingConn = default!;
    static readonly string[] Queries;
    string _query = default!;
    GaussDBCommand _preparedCmd = default!;
    ...
    public void GlobalSetup()
    {
        ...
        _autoPreparingConn = new GaussDBConnection(new GaussDBConnectionStringBuilder(BenchmarkEnvironment.ConnectionString)
        {
            MaxAutoPrepare = 10
        }.ToString());
...
";
        ...
        _preparedCmd = new GaussDBCommand(_query, _conn);
...
";
    ...
    {
        using (var cmd = new GaussDBCommand(_query, _conn))
    ...
    {
        using (var cmd = new GaussDBCommand(_query, _autoPreparingConn))
            return cmd.ExecuteScalar()!;
    }
