...
public class DataAdapterTests : TestBase
{
    ...
    [Test]
    public async Task DataAdapter_GaussDBCommand_in_constructor()
    {
        using var conn = await OpenConnectionAsync();
        using var command = new GaussDBCommand("SELECT 1", conn);
        ...
        var ds = new DataSet();
        da.Fill(ds);
        //ds.WriteXml("TestUseDataAdapterGaussDBConnectionConstructor.xml");
    }
    ...
    {
        using var conn = await OpenConnectionAsync();
        var da = new GaussDBDataAdapter("SELECT 1", conn);
        var ds = new DataSet();
        da.Fill(ds);
        //ds.WriteXml("TestUseDataAdapterStringGaussDBConnectionConstructor.xml");
    }

    [Test]
    public void DataAdapter_connection_string_in_constructor()
    {
        var da = new GaussDBDataAdapter("SELECT 1", ConnectionString);
        var ds = new DataSet();
        da.Fill(ds);
    ...
    public async Task Insert_with_DataSet()
    {
        ...
        var ds = new DataSet();
        var da = new GaussDBDataAdapter($"SELECT * FROM {table}", conn);

        da.InsertCommand = new GaussDBCommand($"INSERT INTO {table} (field_int2, field_timestamp, field_numeric) VALUES (:a, :b, :c)", conn);

        da.InsertCommand.Parameters.Add(new GaussDBParameter("a", DbType.Int16));
        da.InsertCommand.Parameters.Add(new GaussDBParameter("b", DbType.DateTime2));
        da.InsertCommand.Parameters.Add(new GaussDBParameter("c", DbType.Decimal));
        ...
        var dr2 = new GaussDBCommand($"SELECT field_int2, field_numeric, field_timestamp FROM {table}", conn).ExecuteReader();
        dr2.Read();
    ...
    public async Task DataAdapter_update_return_value2()
    {
        ...
        var da = new GaussDBDataAdapter($"select * from {table}", conn);
        var cb = new GaussDBCommandBuilder(da);
        var ds = new DataSet();
        da.Fill(ds);
    ...
    public async Task Fill_with_empty_resultset()
    {
        ...
        var ds = new DataSet();
        var da = new GaussDBDataAdapter($"SELECT field_serial, field_int2, field_timestamp, field_numeric FROM {table} WHERE field_serial = -1", conn);
    ...
    public async Task Fill_add_with_key()
    {
        ...
        var ds = new DataSet();
        var da = new GaussDBDataAdapter($"select field_serial, field_int2, field_timestamp, field_numeric from {table}", conn);
    ...
    public async Task Update_letting_null_field_falue()
    {
        ...
        var command = new GaussDBCommand($"INSERT INTO {table} (field_int2) VALUES (2)", conn);
        command.ExecuteNonQuery();

        var ds = new DataSet();

        var da = new GaussDBDataAdapter($"SELECT * FROM {table}", conn);
        da.InsertCommand = new GaussDBCommand(";", conn);
        da.UpdateCommand = new GaussDBCommand($"UPDATE {table} SET field_int2 = :a, field_timestamp = :b, field_numeric = :c WHERE field_serial = :d", conn);

        da.UpdateCommand.Parameters.Add(new GaussDBParameter("a", DbType.Int16));
        da.UpdateCommand.Parameters.Add(new GaussDBParameter("b", DbType.DateTime));
        da.UpdateCommand.Parameters.Add(new GaussDBParameter("c", DbType.Decimal));
        da.UpdateCommand.Parameters.Add(new GaussDBParameter("d", GaussDBDbType.Bigint));
        ...
        using var dr2 = new GaussDBCommand($"SELECT field_int2 FROM {table}", conn).ExecuteReader();
        dr2.Read();
    ...
    public async Task Fill_with_duplicate_column_name()
    {
        ...
        var ds = new DataSet();
        var da = new GaussDBDataAdapter($"SELECT field_serial, field_serial FROM {table}", conn);
        da.Fill(ds);
    }
    ...
    public async Task DoUpdateWithDataSet()
    {
        ...
        using var dr2 = new GaussDBCommand($"select * from {table}", conn).ExecuteReader();
        dr2.Read();
        Assert.AreEqual(4, dr2["field_int2"]);
    }
    ...
    public async Task Insert_with_CommandBuilder_case_sensitive()
    {
        ...
        var ds = new DataSet();
        var da = new GaussDBDataAdapter($"select * from {table}", conn);
        var builder = new GaussDBCommandBuilder(da);
...
INSERT INTO {table} (interval) VALUES ('1 hour'::INTERVAL);");
        ...
        var da = new GaussDBDataAdapter { SelectCommand = command };
        da.Fill(dt);
    }
...
INSERT INTO {table} (interval) VALUES ('1 hour'::INTERVAL);");
        ...
        // DataColumn c = dt.Columns.Add("dauer", typeof(GaussDBInterval));
        //c.AllowDBNull = true;
        var command = new GaussDBCommand();
    ...
    [Test, Description("Makes sure that the INSERT/UPDATE/DELETE commands are auto-populated on GaussDBDataAdapter")]
    ...
    public async Task Auto_populate_adapter_commands()
    {
        ...
        var da = new GaussDBDataAdapter($"SELECT field_pk,field_int4 FROM {table}", conn);
        var builder = new GaussDBCommandBuilder(da);
        var ds = new DataSet();
        da.Fill(ds);
    ...
    {
        var cb = new GaussDBCommandBuilder();
    ...
    public async Task Get_UpdateCommand()
    {
        ...
        using var da = new GaussDBDataAdapter($"SELECT field_pk, field_int4 FROM {table}", conn);
        using var cb = new GaussDBCommandBuilder(da);
    ...
    public async Task Load_DataTable()
    {
        ...
        using var command = new GaussDBCommand($"SELECT char5, varchar5 FROM {table}", conn);
    ...
    public Task<string> SetupTempTable(GaussDBConnection conn)
