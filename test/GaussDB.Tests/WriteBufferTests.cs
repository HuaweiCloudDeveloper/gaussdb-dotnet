...
class WriteBufferTests
{
    ...
    public void SetUp()
    {
        ...
        WriteBuffer = new GaussDBWriteBuffer(null, Underlying, null, GaussDBReadBuffer.DefaultSize, GaussDBWriteBuffer.UTF8Encoding);
        WriteBuffer.MessageLengthValidation = false;
    }

    // ReSharper disable once InconsistentNaming
    GaussDBWriteBuffer WriteBuffer = default!;
    // ReSharper disable once InconsistentNaming
