...
class PgPostmasterMock : IAsyncDisposable
{
    ...
    static readonly Encoding RelaxedEncoding = GaussDBWriteBuffer.RelaxedUTF8Encoding;
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public GaussDBDataSource CreateDataSource(Action<GaussDBDataSourceBuilder>? configure = null)
    {
    ...
    async Task<ServerOrCancellationRequest> Accept(bool completeCancellationImmediately)
    {
        ...
        var readBuffer = new GaussDBReadBuffer(null!, stream, clientSocket, ReadBufferSize, Encoding,
            RelaxedEncoding);
        var writeBuffer = new GaussDBWriteBuffer(null!, stream, clientSocket, WriteBufferSize, Encoding);
